...
#Parametres for newly contructed modules have requires_grad = True by default
...
PATH = os.path.join('trainedModel.pt')

torch.save(model_conv.state_dict(), PATH)

theModel = myModel()
theModel = torch.load(PATH)
visualize_model(theModel)
